    ...
    <section id="kaise-kaam" className="bg-[#FBF6FF] py-24 px-6 relative">
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="relative">
          ...
          {/* 4 Column Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10 justify-items-center items-stretch">
            ...
            <div className="bg-white rounded-[24px] p-5 flex flex-col items-center text-center shadow-sm border border-[#F0EBFA] w-full max-w-[280px] h-full">
              <img src="/src/assets/step1-icon.png" alt="Step 1 Icon" className="w-14 h-14 object-contain mb-4" />
              ...
              <img src="/src/assets/step1-img.png" alt="Create Account" className="w-[85%] mt-auto object-contain drop-shadow-sm" />
            </div>

            {/* Step 2 - Scaled down max-width, padding, text, and icon sizes */}
            <div className="bg-white rounded-[24px] p-5 flex flex-col items-center text-center shadow-sm border border-[#F0EBFA] w-full max-w-[280px] h-full">
              <img src="/src/assets/step2-icon.png" alt="Step 2 Icon" className="w-14 h-14 object-contain mb-4" />
              <h3 className="font-playfair text-[20px] font-bold text-gray-900 mb-2">
              ...
              <img src="/src/assets/step2-img.png" alt="Set Preferences" className="w-[85%] mt-auto object-contain drop-shadow-sm" />
            </div>

            {/* Step 3 - Scaled down max-width, padding, text, and icon sizes */}
            <div className="bg-white rounded-[24px] p-5 flex flex-col items-center text-center shadow-sm border border-[#F0EBFA] w-full max-w-[280px] h-full">
              <img src="/src/assets/step3-icon.png" alt="Step 3 Icon" className="w-14 h-14 object-contain mb-4" />
              <h3 className="font-playfair text-[20px] font-bold text-gray-900 mb-2">
              ...
              <img src="/src/assets/step3-img.png" alt="Matching Tenders" className="w-[90%] mt-auto object-contain drop-shadow-sm" />
            </div>

            {/* Step 4 - Scaled down max-width, padding, text, and icon sizes */}
            <div className="bg-white rounded-[24px] p-5 flex flex-col items-center text-center shadow-sm border border-[#F0EBFA] w-full max-w-[280px] h-full">
              <img src="/src/assets/step4-icon.png" alt="Step 4 Icon" className="w-14 h-14 object-contain mb-4" />
              <h3 className="font-playfair text-[20px] font-bold text-gray-900 mb-2">
              ...
              <img src="/src/assets/step4-img.png" alt="WhatsApp Reminder" className="w-[90%] mt-auto object-contain drop-shadow-sm" />
            </div>
