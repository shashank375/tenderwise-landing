  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* MOBILE RESPONSIVE FIX: Grouped the Free Account button and Hamburger menu together */}
        <div className="flex items-center gap-2 md:gap-3">
          <a href="https://app.tenderwise.in" target="_blank" rel="noopener noreferrer"
            className="hidden md:block text-sm text-[#472C70] border border-[#472C70] px-4 py-2 rounded-full hover:bg-[#472C70] hover:text-white transition">
            Search Tender
          </a>
          
          <a href="https://app.tenderwise.in" target="_blank" rel="noopener noreferrer"
            className="text-[8.95px] md:text-sm bg-[#472C70] text-white px-2.5 py-1.5 md:px-4 md:py-2 rounded-full hover:opacity-90 transition whitespace-nowrap">
            Free Account Banao
          </a>

          <button className="md:hidden text-gray-800 ml-1" onClick={() => setMenuOpen(!menuOpen)}>
